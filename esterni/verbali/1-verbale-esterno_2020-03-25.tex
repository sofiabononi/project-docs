...
\begin{enumerate}
  ...
  sugli algoritmi di Machine Learning che si andranno ad utilizzare (\glossario{Regressione Lineare}, \glossario{SVM} e accenno sulle \glossario{reti neurali}).
  ...
  \item \textbf{Richiesta di conferma sui linguaggi da utilizzare}: l'azienda ha confermato l'utilizzo di \glossario{JavaScript} sia per
  quanto riguarda l'applicazione client-side che per l'elaborazione dati server-side. Ha inoltre suggerito
  l'utilizzo del \glossario{framework} \glossario{Electron} per lo sviluppo dell'applicazione web client-side.
