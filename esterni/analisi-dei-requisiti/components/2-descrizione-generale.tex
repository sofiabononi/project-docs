...
\label{subs:obiettivo_del_prodotto}
	Il progetto \emph{Predire in Grafana} si pone come obiettivo finale la realizzazione di un \glossario{plug-in} per il sistema di monitoraggio \glossario{Grafana}. Il plug-in deve essere accompagnato con un programma esterno per l' \glossario{addestramento} per i \glossario{modelli} di \glossario{machine learning}, grazie a questo esso sarà in grado di adattarsi ai diversi flussi di dati e riuscirà a fornire delle \glossario{previsioni} sulle possibili \glossario{criticità} riscontrate sulla linea di produzione del software. Gli utenti del software potranno analizzare la situazione tramite grafici e \glossario{dashboard}, facilitando la visualizzazione di problematiche anche gravi all'interno della linea di produzione.
...
\label{subs:funzioni_del_prodotto}
	...
	\begin{itemize}
		...
		\item{Se si è in possesso di un file già processato dall'applicazione allora esso può essere caricato nuovamente con un formato \glossario{JSON} per ottenere un aggiornamento dei valori in base rispetto ai nuovi dati;}
	...
	\begin{itemize}
			...
			\item{Selezionare il file JSON con la definizione del modello usato e i risultati dell'addestramento, ovvero il \glossario{predittore} da usare;}
...
\label{subs:architetture_e_tecnologie_del_progetto}
	...
	\subsubsubsection{Programma di addestramento}
	...
	\subsubsubsection{Plug-in di previsione}
...
\label{subs:vincoli_generali}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\newline \href{https://www.npmjs.com/package/ml-modules}}
			...
			\newline \href{https://github.com/karpathy/svmjs} 
			\newline \href{https://github.com/Tom-Alexander/regression-js}}
			\item{Per le \glosario{reti neurali} in JavaScript, il proponente consiglia l'uso della libreria presente al seguente link:
			\newline \href{https://cd.standford.edu/people/karpathy/convnetis}}
		\end{itemize}
