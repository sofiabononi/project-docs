...
\begin{longtable}[H]{>{\centering\bfseries}m{2cm} >{\centering}m{9cm} >{\centering}m{2.5cm} >{\centering\arraybackslash}m{2.5cm}}
  ...
  \textbf{RFO5} & Il sistema deve mettere a disposizione la possibilità di visualizzare la previsione utilizzando un indicatore. & Obbligatorio & UC5 \\
  \textbf{RFO6} & Il sistema deve permettere all'utente di selezionare il modello SVM per l'allenamento. & Obbligatorio & UC6 \\
  \textbf{RFO7} & Il sistema deve permettere all'utente di selezionare il modello RL per l'allenamento. & Obbligatorio & UC7 \\
  \textbf{RFF8} & Il sistema può permettere all'utente di selezionare la regressione esponenziale per l'allenamento. & Facoltativo & UC8 \\
  \textbf{RFF9} & Il sistema può permettere all'utente di selezionare la regressione logaritmica per l'allenamento. & Facoltativo & UC9 \\
  \textbf{RFF10} & Il sistema può permettere all'utente di selezionare il modello rete neurale per l'allenamento. & Facoltativo & UC10 \\
  \textbf{RFF11} & Il sistema può permettere all'utente di selezionare il modello SVM adattata alla regressione per l'allenamento. & Facoltativo & UC11 \\
  \textbf{RFO12} & Il sistema deve mettere a disposizione dell’utente un pulsante per l’avvio della predizione. & Obbligatorio & UC12 \\
  \textbf{RFO13} & Il sistema deve mettere a disposizione dell’utente un pulsante per interrompere la predizione. & Obbligatorio & UC13 \\
  \textbf{RFF14} & Il sistema può mettere a disposizione dell’utente un metodo per l’impostazione degli alert. & Facoltativo & UC14 \\
  \textbf{RFF14.1} & Il sistema può mostrare un pulsante che permetta all'utente di creare un alert. & Facoltativo & UC14.1 \\
  \textbf{RFF14.2} & Il sistema può mettere a disposizione un sistema per inserire una soglia di alert. & Facoltativo & 14.2 \\
  \textbf{RFD14.2.1} & Il sistema, utilizzando un alert, potrebbe notificare un messaggio di errore nel caso in cui venga superata la soglia impostata. & Desiderabile & UC23 \\
  \textbf{RFD15} & Il sistema potrebbe permettere all'utente di eliminare il pannello di monitoraggio. & Desiderabile & UC15 \\
  \textbf{RFD15.1} & Il sistema potrebbe visualizzare un messaggio di errore nel caso in cui si cerchi di eliminare il pannello senza interrompere la previsione. & Desiderabile & UC24 \\
  \textbf{RFO16} & Il sistema deve mettere a disposizione all'utente un metodo per la visualizzazione delle previsioni. & Obbligatorio & UC16 \\
