...
Il prodotto si suddivide in due parti: un'applicazione web per addestrare i \glossario{predittori} e un plug-in per la piattaforma Grafana; le suddette parti utilizzano tecnologie che verranno elencate nei successivi paragrafi.
