...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=15cm]{schermataTrainingApp.png}\\
...
Successivamente è possibile scegliere un file \glossario{CSV}contenente i dati con cui si vuole compiere l'addestramento. Per caricare il file è sufficiente premere il pulsante sotto la scritta "CSV data file:"
