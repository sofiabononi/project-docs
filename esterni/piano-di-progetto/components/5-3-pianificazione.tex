...
\begin{document}
  ...
  Nella macro-fase di Progettazione architetturale, la distribuzione oraria è la seguente:
  \begin{table}[H]
    \centering
    ...
    \end{tabular}
    \caption{Distribuzione oraria della macro-fase di Progettazione architetturale}
  \end{table}
  ...
  \begin{figure}[H]
    ...
    \caption{Istogramma della distribuzione oraria della macro-fase di Progettazione architetturale}
  ...
  \begin{table}[H]
    ...
    \end{tabular}
    \caption{Prospetto economico della macro-fase di Progettazione architetturale}
  \end{table}
  ...
  \begin{figure}[H]
    ...
    \caption{Areogramma della suddivisione dei ruoli della macro-fase di Progettazione architetturale}
