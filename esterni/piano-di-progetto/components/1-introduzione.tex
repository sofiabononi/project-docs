...
\begin{itemize}
    ...
    \item \textbf{Revisione dei Qualifica}: %TODO mettere la data
    \item \textbf{Revisione di Accettazione}: %TODO mettere la data 
\end{itemize}

\section{Fonti}
Vengono riportate del fonti delle immagini riportate in questo documento.
\begin{itemize}
