...
\begin{figure}[H]
  ...
  Ogni incremento verrà considerato come \emph{periodo} nel quale verrano svolte del attività riportate nei rispettivi diagrammi di Gantt. Ogni periodo viene strutturato come segue:
  \begin{itemize}
