...
\begin{itemize}
    ...
    \item \textbf{I periodo (2020-03-09 - 2020-03-16)}:
        ...
        \begin{itemize}
            ...
            \item \textbf{Resoconto}: stesura del consuntivo di periodo e analisi dei rischi riscontrati;
        ...
        \begin{itemize}
            \item \textbf{Stesura lettera di presentazione}: stesura della lettera di presentazione per la prima revisione di avanzamento;
            \item \textbf{Ricerca degli strumenti}: ricerca e studio autonomo degli strumenti richiesti dal proponente per lo sviluppo del progetto;
