...
In questo processo viene messo in atto il \glossario{Way of Working}, redatto per la consultazione dell'intero \glossario{team di sviluppo} presente nelle \textsc{Norme di Progetto v3.11-2.4.1}, il quale ha un'importanza significativa perché la corretta attuazione delle regole contenute al suo interno andrà a condizionare la qualità dell'intero progetto.
...
\begin{itemize}
    ...
    \item \textbf{Dividere i compiti}: È fondamentale la corretta suddivisione dei compiti all'interno dei componenti del gruppo \emph{CoffeeCode} per non creare incomprensioni;
    ...
    \item \textbf{Stima budget}: Bisogna prendere atto delle proprie risorse in termini di $\frac{tempo}{persona}$ in modo da rispettare il \glossario{preventivo} stilato nel \textsc{Piano di Progetto v1.4-3.1.0}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{QoPR002 Rispetto del budget istanziato}: Devono potersi mantenere le risorse definite all'inizio del progetto;
        \begin{itemize}
            ...
            \item \textbf{Valore desiderabile}: Corrisponde al preventivo definito nel \textsc{Piano di Progetto v1.4-3.1.0}.
        \end{itemize}
...
\label{sub:analisi}
In questo processo viene fatta un'analisi più generica, comprendente altri contenuti che non si riferiscono solo all'analisi dei requisiti (consultabile nel documento \textsc{Analisi dei Requisiti v1.9-1.3.0}) o all'analisi dei rischi (consultabile nel documento \textsc{Piano di Progetto v1.4-3.1.0}), ma che comprende altre attività riportate dalle seguenti funzioni:
...
Il processo segue di pari passo il ciclo di vita di ogni documento, come spiegato nelle \textsc{Norme di Progetto v3.11-2.4.1} e prevede le fasi di:
\begin{itemize}
    \item Redazione;
    \item Modifica;
    \item Verifica;
...
\begin{itemize}
    \item \textbf{QoPR09 Rispetto delle fasi del ciclo di vita}: Deve essere rispettata ogni fase del ciclo di vita del documento e le scadenze previste;
        ...
        \end{itemize}
    \item \textbf{QoPR010 Rispetto nella redazione dei documenti}: Devono essere rispettate le linee guida inserite nelle \textsc{Norme di Progetto v3.11-2.4.1}.
        \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Verificare l'aderenza alle Norme di Progetto}: Viene verificato il rispetto del \textit{Way Of Working}, contenuto nelle \textsc{Norme di Progetto v3.11-2.4.1};
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Valore desiderabile}: /.
    \end{itemize}
    \item \textbf{QoPR013 Rispettare le fasi di verifica}: Si esegue la fase di verifica in modo iterativo, rispettando sempre ciò che è stato deciso all'interno delle \textsc{Norme di Progetto v3.11-2.4.1}, in modo da rendere coerenti i risultati ottenuti;
        \begin{itemize}
    ...
    \item \textbf{QoPR014 Soddisfare i test richiesti}: Viene verificato costantemente il soddisfacimento dei test definiti.
        \begin{itemize}
            ...
            \item \textbf{Valore accettabile}: 85\%; %definire meglio nelle norme
