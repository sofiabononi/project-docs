...
\begin{longtable}[c]{cccc}
    ...
    \begin{tabular}[c]{@{}c@{}}QoPR003 Rispetto del \\ ciclo di vita scelto\end{tabular} &
      ...
      \begin{tabular}[c]{@{}c@{}}Livello di maturità:  3\\ Valutazione attributi:  L\end{tabular} &
      \begin{tabular}[c]{@{}c@{}}Livello di maturità:  3\\ Valutazione attributi:  L\end{tabular} \\
    \multicolumn{1}{l}{Descrizione:} &
    ...
    \begin{longtable}[c]{cccc}
        ...
        \begin{longtable}[c]{cccc}
            ...
            \begin{tabular}[c]{@{}c@{}}QoPR09  Rispetto delle fasi del \\ ciclo di vita\end{tabular} &
              ...
              / \\
            \multicolumn{1}{l}{Descrizione:} &
              \multicolumn{3}{l}{\begin{tabular}[c]{@{}l@{}}Ogni documento attraversa determinate fasi del ciclo di vita del prodotto. \\ I verificatori hanno il compito di verificare la corretta attuazione del\\ way of working nel documento in ogni sua fase.\end{tabular}} \\ \hline
        ...
        \begin{longtable}[c]{cccc}
            ...
            \begin{tabular}[c]{@{}c@{}}QoPR011 Attuare una verifica \\ costante\end{tabular} &
              ...
              / \\
            \multicolumn{1}{l}{Descrizione:} &
              \multicolumn{3}{l}{\begin{tabular}[c]{@{}l@{}}Il \glossario{Verificatore} deve controllare il prodotto frequentemente, in modo\\  da correggerlo nella sua forma, contenuto e nelle funzionalità.\end{tabular}} \\ \hline
