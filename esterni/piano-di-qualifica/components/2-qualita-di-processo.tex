...
In questo processo viene messo in atto il \glossario{Way of Working}, redatto per la consultazione dell'intero \glossario{team di sviluppo} presente nelle \textsc{Norme di Progetto v1.9-2.3.3}, il quale ha un'importanza significativa perché la corretta attuazione delle regole contenute al suo interno andrà a condizionare la qualità dell'intero progetto.
...
Il processo segue di pari passo il ciclo di vita di ogni documento, come spiegato nelle \textsc{Norme di Progetto v1.9-2.3.3} e prevede le fasi di:
\begin{itemize}
    \item Redazione;
    \item Modifica;
    \item Verifica;
...
\begin{itemize}
    \item \textbf{QoPR09 Rispetto delle fasi del ciclo di vita}: Deve essere rispettata ogni fase del ciclo di vita del documento e le scadenze previste;
        ...
        \end{itemize}
    \item \textbf{QoPR010 Rispetto nella redazione dei documenti}: Devono essere rispettate le linee guida inserite nelle \textsc{Norme di Progetto v1.9-2.3.3}.
        \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Verificare l'aderenza alle Norme di Progetto}: Viene verificato il rispetto del \textit{Way Of Working}, contenuto nelle \textsc{Norme di Progetto v1.9-2.3.3};
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Valore desiderabile}: /.
    \end{itemize}
    \item \textbf{QoPR013 Rispettare le fasi di verifica}: Si esegue la fase di verifica in modo iterativo, rispettando sempre ciò che è stato deciso all'interno delle \textsc{Norme di Progetto v1.9-2.3.3}, in modo da rendere coerenti i risultati ottenuti;
        \begin{itemize}
