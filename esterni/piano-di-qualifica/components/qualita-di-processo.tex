\documentclass[../paino-di-qualifica.tex]{subfiles}
...
In questo processo viene messo in atto il \glossario{WAY OF WORKING}, redatto per la consultazione dell'intero \glossario{TEAM DI SVILUPPO}, il quale ha un'importanza significativa perché la corretta attuazione del delle regole contenute al suo interno andranno a condizionare la qualità dell'intero progetto.
