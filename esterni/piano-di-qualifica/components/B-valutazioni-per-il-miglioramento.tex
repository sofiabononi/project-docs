...
Dovendo lavorare su due differenti prodotti software, ovvero il programma di addestramento e il plugin, il team ha deciso di ottimizzare il tempo a sua disposizione definendo due differenti gruppi di lavoro, uno per ogni prodotto da realizzare.
Grazie a questo il lavoro è stato svolto in modo più efficiente e le comunicazioni sugli aggiornamenti relativi ai prodotti sono risultate semplificate.
...
Il gruppo quindi ha cercato di investire più tempo per ricavare informazioni e apprendere da essere, su come procedere per la realizzazione del plugin che comunque è stato sviluppato secondo i tempi stabiliti. 
