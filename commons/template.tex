...
\begin{titlepage}% per non stampare il numero della pagina
  ...
  {\hspace{0.15\textwidth}\includegraphics[width=4cm,height=4cm]{logo.jpg}}\\[4\baselineskip] % logo
...
\begin{longtable}[H]{>{\centering\bfseries}m{2cm} >{\centering}m{4cm} >{\centering}m{3cm} >{\centering}m{1.5cm} >{\centering\arraybackslash}m{5cm}}
  \rowcolor{lightgray}
