...
La \glossario{web-application} dovrà essere suddivisa in 3 macro-sezioni:
\begin{itemize}
...
\begin{itemize}
    ...
    \item \glossario{Java 8}: linguaggio di programmazione di alto livello \glossario{orientato agli oggetti};
    \item \glossario{PostgreSQL}, \glossario{TimescaleDB}, \glossario{ClickHouse}: tipologie di database suggerite;
    \item \glossario{Bootstrap}: \glossario{framework} per la realizzazione di applicazioni web;
...
\begin{itemize}
    \item Il linguaggio \glossario{Java} è già conosciuto da tutto il gruppo;
