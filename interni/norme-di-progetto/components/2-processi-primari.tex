...
L'aspettativa di questo processo è l'analisi dei requisiti concordati con il proponente; parallelamente, questi vengono documentati nell'\textsc{Analisi dei Requisiti}, il quale contiene appunto i requisiti richiesti per la realizzazione del progetto.
