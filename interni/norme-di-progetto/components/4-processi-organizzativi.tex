...
\end{itemize}
Queste attività sono documentate dal responsabile nel \textsc{Piano di progetto v3.11-4.4.0}.
...
Le attività previste da questo processo sono contenute nel \textsc{Piano di progetto v3.11-4.4.0}; queste sono:
\begin{itemize}
...
I diversi ruoli sono cambiati a rotazione, in modo che ogni membro del gruppo possa ricoprire ogni ruolo almeno una volta durante il progetto. Nel \textsc{Piano di progetto v3.11-4.4.0} sono pianificate e organizzate le attività assegnate ad ogni ruolo. \\
...
\begin{itemize}
  ...
  \item Redige il \textsc{Piano di progetto v3.11-4.4.0};
...
\begin{itemize}
  ...
  \item Collabora alla redazione del \textsc{Piano di progetto v3.11-4.4.0};
  \item Redige le \textsc{Norme di Progetto v3.11-2.4.1}, in particolar modo è responsabile dei piani e delle procedure di Gestione per la Qualità.
\end{itemize}
...
\begin{itemize}
  ...
  \item Redige i documenti \textsc{Analisi dei requisiti v3.11-1.4.0} e \textsc{Studio di fattibilità v1.4-1.1.0}.
\end{itemize}
...
\begin{itemize}
  \item Ispeziona i prodotti in fase di revisione, facendo capo a quanto scritto nelle \textsc{Norme di Progetto v3.11-2.4.1};
  \item Evidenzia eventuali errori del prodotto ispezionato e li comunica all'autore del prodotto stesso;
  \item Redige il \textsc{Piano di qualifica v3.11-4.0.0}.
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\#analisi-dei-requisiti}: canale per le comunicazioni riguardanti il documento \textsc{Analisi dei requisiti v3.11-1.4.0};
  \item \textbf{\#norme-di-progetto}: canale per le comunicazioni riguardanti il documento \textsc{Norme di Progetto v3.11-2.4.1};
  \item \textbf{\#piano-di-progetto}: canale per le comunicazioni riguardanti il documento \textsc{Piano di progetto v3.11-4.4.0};
  \item \textbf{\#piano-di-qualifica}: canale per le comunicazioni riguardanti il documento \textsc{Piano di qualifica v3.11-4.0.0};
  \item \textbf{\#studio-di-fattibilità}: canale per le comunicazioni riguardanti il documento \textsc{Studio di fattibilità v1.4-1.1.0};
...
I rischi vengono rilevati dal responsabile e da lui riportati nel \textsc{Piano di progetto v3.11-4.4.0}; è una procedura dinamica: nel caso in cui vengano rilevati nuovi rischi, questi saranno aggiunti nell'analisi dei rischi. \\
...
\begin{itemize}
  ...
  \item Registrare ogni riscontro previsto dei rischi nel \textsc{Piano di progetto v3.11-4.4.0};
  \item Aggiungere i nuovi rischi che vengono man mano individuati nel \textsc{Piano di progetto v3.11-4.4.0};
...
Gli altri strumenti di cui il gruppo fa uso, già documentati nelle \textsc{Norme di Progetto v3.11-2.4.1}, sono:
\begin{itemize}
  \item Telegram;
  \item Git;
  \item Git Commitizen;
...
Si vuole misurare la copertura delle risorse disponibili per il progetto, in particorale si vuole assicurare che l'utilizzo di queste sia coerente con quanto annunciato nel \textsc{Piano di progetto v3.11-4.4.0}. \\
...
\begin{itemize}
  ...
  \item \textbf{Formula}: la formula della metrica è la seguente:
    ...
    \end{itemize}
    \item \textbf{Procedura per il calcolo}: questa metrica viene calcolata manualmente, riferendosi a quanto riportato nel \textsc{Piano di progetto v3.11-4.4.0} per quanto riguarda i giorni di scadenza prefissati.
