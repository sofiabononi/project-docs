...
\begin{itemize}
  ...
  \begin{enumerate}
    ...
    \item Riportare i valori ottenuti nell'opportuna sezione del \textsc{Piano di Qualifica v}.
  \end{enumerate}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{\glossario{TravisCI}} per le operazioni di controllo basate sui test definiti nel \textsc{Piano di Qualifica v1.4-2.0.0} e il supporto al versionamento dei documenti e delle componenti software.
\end{itemize}
