...
In accompagnamento ai documenti ufficiali viene fornito un \textsc{Glossario v1.0.0}, contenente tutti i termini caratterizzati da sottolineatura e una G maiuscola come pedice. Il glossario ha la funzione di chiarire possibili fraintendimenti provenienti dall'utilizzo di determinati termini. \\
...
\begin{itemize}
  \item MoPD010 \glossario{Indice di Gulpease};
...
Nel documento \textsc{Piano di Qualifica v1.0.0} vengono utilizzate le seguenti codifiche.
