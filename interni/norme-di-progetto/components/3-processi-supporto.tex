...
\begin{itemize}
  ...
  \item \textbf{\glossario{TravisCI}} per le operazioni di controllo basate sui test definiti nel \textsc{Piano di qualifica v3.11-4.0.0} e il supporto al versionamento dei documenti e delle componenti software.
\end{itemize}
